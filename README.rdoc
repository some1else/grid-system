...
For more info, take a look at {The Example}[http://github.com/Artiqulate/Grid-System-Example] (Also shows how to get backwards compatibility with the old syntax working)
