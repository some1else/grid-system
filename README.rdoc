...
For more info, take a look at {example.sass}[http://github.com/Artiqulate/Grid-System/blob/master/example.sass] (Also shows how to get backwards compatibility with the old syntax working)
